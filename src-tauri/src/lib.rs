...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::script_runner::script_save,
            commands::script_runner::script_list,
            commands::script_runner::script_delete,
            commands::script_runner::script_start,
            commands::script_runner::script_read_run,
            commands::script_runner::script_stop_run,
